...
def can_use_tma(*matrices: IRNode, output_layout: Layout, add_guards: bool = False) -> bool:
    """
    ...
    * https://docs.nvidia.com/cuda/cuda-driver-api/group__CUDA__TENSOR__MEMORY.html
    ...
    def _is_tma_compatible_layout(layout: Layout) -> bool:
        sizes = layout.size
...
def use_triton_tma_template(*matrices: IRNode, output_layout: Layout, add_guards: bool = False) -> bool:
    return (
        can_use_tma(*matrices, output_layout=output_layout, add_guards=add_guards)
